class ApiUrlConstants {
  static const String baseUrlMain = 'https://server-php-8-2.technorizen.com';
  static const String baseUrl = '$baseUrlMain/nuru/api/';
  ...
  static const String endPointOfProductsById = '/nuru/api/products-by-id';
  static const String endPointOfCategoriesByMainCategoryId =
      '/nuru/api/categories-by-main-category-id';
  static const String endPointOfSubCategoriesByCategoryId =
      '/nuru/api/sub-categories-by-category-id';
  static const String endPointOfGetSupportiveCommunityDetails =
      '/nuru/api/SupportiveCommunity/get-supportive-community-details';
  ...
  static const String endPointOfGetWorkout = '${baseUrl}get-workout';
  static const String endPointOfGetWorkoutWeek = '/nuru/api/get-workout-week';
  static const String endPointOfGetSingleVideo =
      '/nuru/api/sleep-management/get-single-video';
  static const String endPointOfIntimacySubCategoryGetIntimacySubcategory =
      '/nuru/api/IntimacysubCategory/get-intimacy-subcategory';
  static const String
      endPointOfExpertConsultationGetExpertConsultationDoctorsByCategories =
      '/nuru/api/expert-consultation/get-expert-consultation-doctors-by-categories';
  static const String endPointOfLoveSubLanguageGetLoveSubLanguage =
      '/nuru/api/LovesubLanguage/get-love-sublanguage';
  static const String endPointOfProductsByCategoryId =
      '/nuru/api/products-by-category-id';
  static const String endPointOfGetWorkoutBlogByWorkoutWeekId =
      '/nuru/api/get-workout-blog-by-workout-week-id';
  static const String endPointOfGetSupplimentPlan =
      '/nuru/api/get-suppliment-plan';
  static const String
      endPointOfNutritionalGuidanceGetNutritionalGuidanceBlogBySubCategorieId =
      '/nuru/api/nutritional-guidance/get-nutritional-guidance-blog-by-sub-categorie-id';
  static const String endPointOfAddressByUserId =
      '/nuru/api/address-by-user-id';
  static const String endPointOfCarts = '/nuru/api/carts';
  static const String endPointOfCycleTrackingOption =
      '/nuru/api/cycle-tracking-option';
  static const String endPointOfCycleTrackingSubOption =
      '/nuru/api/cycle-tracking-sub-option';
  ...
  static const String endPointOfGetBodyParts = '${baseUrl}get-body-parts';
  ...
  static const String endPointOfPosts = '/nuru/api/posts';
  static const String endPointOfGetHealthRecord = '/nuru/api/get_health_record';
  static const String endPointOfGetProfile = '/nuru/api/get_profile';
  static const String endPointOfQuestions = '/nuru/api/questions';
  ...
  static const String endPointOfRomanticSpotGetRomanticSpot =
      '/nuru/api/RomanticSpot/get-romantic-spot';
  static const String endPointOfGetEBookByCategory =
      '/nuru/api/EbookCategory/get-ebook-by-category';
  static const String endPointOfGetSaveIntimacyManagementBlogs =
      '/nuru/api/sleep-management/intimacy-management/get-save-intimacy-management-blogs';
  ...
  static const String endPointOfGetNextVideoListDiscover =
      '/nuru/api/sleep-management/get-next-video-list-discover';
  static const String
      endPointOfSleepManagementGetSleepManagementSoundTracksById =
      '/nuru/api/sleep-management/get-sleep-management-sound-tracks-by-id';
  static const String
      endPointOfGetDoctorUpcomingAppointment =
      '/nuru/api/GetbookingAppointment/get-doctor-upcoming-appointment';
  static const String endPointOfSaveIntimacyManagementBlogs =
      '/nuru/api/sleep-management/intimacy-management/save-intimacy-management-blogs';
  static const String endPointOfSaveIntimacySubcategory =
      '/nuru/api/IntimacysubCategory/save-intimacy-subcategory';
  static const String
      endPointOfSleepManagementFavoritesSleepManagementSoundTrackAddFavourites =
      '/nuru/api/sleep-management/favorites/sleep-management-sound-track-add-favourites';
  static const String endPointOfSleepManagementZenBookGetZenBookProvidersById =
      '/nuru/api/sleep-management/zen-book/get-zen-book-providers-by-id';
  static const String endPointOfSleepManagementZenBookGetZenBookAddBookings =
      '/nuru/api/sleep-management/zen-book/get-zen-book-add-bookings';
  static const String
      endPointOfSleepManagementIntimacyManagementGetIntimacyManagementCategoriesBlogs =
      '/nuru/api/sleep-management/intimacy-management/get-intimacy-management-categories-blogs';
  static const String endPointOfFertilityEducationsGetFertilityTestKit =
      '/nuru/api/fertility-educations/get-fertility-test-kit';
  static const String endPointOfPersonalTrainerCategories =
      '/nuru/api/personal-trainer/get-personal-trainer-category';
  static const String endPointOfPersonalTrainerList =
      '${baseUrl}personal-trainer/get-personal-trainer';
  ...
  static const String endPointOfGetExpertConsultationDoctorsDetails =
      '/nuru/api/expert-consultation/get-expert-consultation-doctors-details';
  ...
  static const String endPointOfGetPersonalTrainerDetails =
      '/nuru/api/personal-trainer/get-personal-trainer-details';
  static const String endPointOfGetClinicNotification =
      '/nuru/api/ClinicNotification/get-clinic-notification';
  static const String endPointOfGetDoctorAppointmentDetails =
      '/nuru/api/GetbookingAppointment/get-doctor-appointment-details';
  ...
  static const String endPointOfGetBlogSaved =
      '${baseUrl}fertility-educations/get-fertility-educations-saved-blog';
  static const String endPointOfGetBlogByCategory =
      '/nuru/api/fertility-educations/get-fertility-educations-blogs-by-category';
  static const String endPointOfGetFertilityWebinarsBlogsByCategory =
      '/nuru/api/fertility-educations/get-fertility-webinars-blogs-by-category';
  static const String endPointOfGetFertilityWebinarsDetails =
      '/nuru/api/fertility-educations/get-fertility-webinars-details';
  static const String
      endPointOfFertilityEducationsGetFertilityEducationsBlogsDetails =
      '/nuru/api/fertility-educations/get-fertility-educations-blogs-details';
  ...
  static const String endPointOfGetSupportivePeace =
      '/nuru/api/SupportiveCommunity/get-supportive-peace';
  ...
  static const String endPointOfGetForumCategory =
      '${baseUrl}sleep-management/get-forum-category';
  ...
  static const String endPointOfGetTVSClinicDetail =
      '/nuru/api/tvsscan/get-scan-clinic-detail-by-id';
  static const String endPointOfGetTVSBookingAppointment =
      '/nuru/api/GetbookingAppointment/get-booking-appointment';
  static const String endPointOfGetPeaceSubCategory =
      '/nuru/api/SupportiveCommunity/get-peace-sub-category';
  static const String
      endPointOfSleepManagementZenBookGetZenBookNearestProviders =
      '/nuru/api/sleep-management/zen-book/get-zen-book-nearest-providers';
  static const String
      endPointOfGetUpcomingBookingAppointment =
      '/nuru/api/GetbookingAppointment/get-upcoming-booking-appointment';
}
